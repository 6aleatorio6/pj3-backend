...
CREATE TABLE IF NOT EXISTS `dbPj3`.`usuario` (
  ...
  `senhaHash` VARCHAR(100) NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `dbPj3`.`catalogo` (
  ...
  UNIQUE INDEX `funcionario_autor_UNIQUE` (`funcionario_autor` ASC) ,
...
CREATE TABLE IF NOT EXISTS `dbPj3`.`lidoPeloUser` (
  ...
  UNIQUE INDEX `usuario_id_UNIQUE` (`usuario_id` ASC) ,
  INDEX `fk_lidoPeloUser_catalogo1_idx` (`catalogo_uuid` ASC) ,
...
CREATE TABLE IF NOT EXISTS `dbPj3`.`foto` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  INDEX `fk_foto_catalogo1_idx` (`catalogo_uuid` ASC) ,
