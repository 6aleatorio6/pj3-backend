    ...
    const datCat = [
      {
        ...
        funcionarioId: 1,
        descricao:
          'A Aranha Pernuda é um aracnídeo encontrado em áreas tropicais, conhecido por suas longas pernas e habilidades de tecer teias complexas e resistentes.',
      ...
      },
      {
        ...
        funcionarioId: 2,
        descricao:
          'O Calango é um lagarto pequeno e ágil encontrado em diversas regiões do Brasil, principalmente em áreas quentes e secas, conhecido por sua capacidade de se camuflar.',
        nomePopular: 'Calango',
      ...
      },
      {
        ...
        funcionarioId: 1,
        descricao:
          "A Capivara (Hydrochoerus hydrochaeris) é o maior roedor do mundo, encontrado em grande parte da América do Sul, vivendo próximo a corpos d'água e conhecida por seu comportamento sociável.",
      ...
      },
      {
        ...
        funcionarioId: 2,
        descricao:
          'O Caraguatá é uma planta da família Bromeliaceae, nativa de regiões tropicais da América do Sul, conhecida por suas folhas espinhosas e flores coloridas.',
      ...
      },
      {
        ...
        funcionarioId: 1,
        descricao:
          'O Esquilo (Sciurus vulgaris) é um roedor encontrado em florestas da Europa e da Ásia, conhecido por sua cauda espessa e peluda e por armazenar alimentos para o inverno.',
        nomePopular: 'Esquilo',
      ...
      },
      {
        ...
        funcionarioId: 2,
        descricao:
          'O Juqueriquere-tupi-guarani é uma planta rara, nativa de regiões específicas do Brasil, conhecida por suas propriedades medicinais e por seu nome de origem indígena.',
      ...
      },
      {
        ...
        funcionarioId: 1,
        descricao:
          'O Passarinho-vermelho-sangue é uma ave conhecida por sua plumagem vibrante e canto melodioso, comum em diversas regiões do Brasil, especialmente em áreas de floresta.',
      ...
      },
      {
        ...
        funcionarioId: 2,
        descricao:
          'A Quaresmeira é uma árvore nativa do Brasil, conhecida por suas flores roxas que florescem durante a quaresma, sendo comum em jardins e parques urbanos.',
      ...
      },
      {
        ...
        funcionarioId: 1,
        descricao:
          'A Saíra-sete-cores é uma pequena ave de plumagem multicolorida, encontrada em florestas tropicais e conhecida por sua beleza e pelo canto melodioso.',
      ...
      },
      {
        ...
        funcionarioId: 2,
        descricao:
          'O Tatu é um mamífero noturno encontrado em várias partes da América do Sul, conhecido por sua carapaça dura que o protege de predadores.',
        nomePopular: 'Tatu',
      ...
      },
      {
        ...
        funcionarioId: 1,
        descricao:
          'O Teiú é um lagarto grande encontrado em florestas tropicais da América do Sul, conhecido por sua pele escamosa e comportamento agressivo quando ameaçado.',
        nomePopular: 'Teiú',
      ...
      },
      {
        ...
        funcionarioId: 2,
        descricao:
          'O Tucano-bico-verde (Ramphastos dicolorus) é uma ave tropical da América do Sul, reconhecida pelo bico verde e corpo colorido, habitando florestas e matas densas.',
